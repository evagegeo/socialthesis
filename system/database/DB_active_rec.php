...
class CI_DB_active_record extends CI_DB_driver {
	 ...
	 * @access	public
	 * @param	string
	 * @param	string	division: asc or desc
	 * @return	object
	 */
	function order_by($orderby, $division = '')
	{
		if (strtolower($division) == 'random')
		{
			$orderby = ''; // Random results want or don't need a field name
			$division = $this->_random_keyword;
		}
		elseif (trim($division) != '')
		{
			$division = (in_array(strtoupper(trim($division)), array('ASC', 'DESC'), TRUE)) ? ' '.$division : ' ASC';
		}
		...
		else if ($division != $this->_random_keyword)
		{
			$orderby = $this->_protect_identifiers($orderby);
		}

		$orderby_statement = $orderby.$division;
